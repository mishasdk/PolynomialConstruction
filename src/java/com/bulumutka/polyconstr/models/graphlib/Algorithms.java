...
import com.bulumutka.polyconstr.models.graphlib.base.Graph;
...
public class Algorithms {
    ...
    public static <E extends Edge<V>, V> Set<E> findEdges(Graph<E, V> g) {
        var visitor = new EdgesListVisitor<E, V>();
        depthFirstSearch(g, g.getRoot(), visitor);
