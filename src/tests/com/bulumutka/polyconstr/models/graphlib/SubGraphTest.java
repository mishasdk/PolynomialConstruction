...
class SubGraphTest {
    ...
    public void outgoingEdgesTest() {
        ...
        var sg = new SubGraph(g, edge -> !"0".equals(edge.time));
    ...
    public void showSubGraphTest() {
        ...
        builder.addEdge(0, 4, "1");
        builder.setRoot(0);
        var g = new SubGraph(builder.build(), edge -> !"0".equals(edge.time));
        assertEquals(2, g.outgoingEdges(0).size());
        System.out.println(g);

        g = new SubGraph(builder.build(), edge -> "0".equals(edge.time));
        assertEquals(2, g.outgoingEdges(0).size());
        System.out.println(g);
    }
}
